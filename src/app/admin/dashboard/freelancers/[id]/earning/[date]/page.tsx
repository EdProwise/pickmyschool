...
export default function AdminFreelancerEarningDetailPage() {
    ...
    <div className="p-8 space-y-6">
      <div className="flex items-center gap-4">
        <Button
          variant="outline"
          size="sm"
          onClick={() => router.push(`/admin/dashboard/freelancers/${freelancerId}/earning`)}
          className="gap-1.5"
        >
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-800">View Details</h1>
          <p className="text-slate-500 text-sm mt-0.5 flex items-center gap-1.5">
            <Calendar className="w-4 h-4" />
            {displayDate}
            {freelancer && <span className="text-slate-400">· {freelancer.name}</span>}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4">
        ...
        {freelancer && (
          <div className="flex items-center gap-2 bg-cyan-50 border border-cyan-100 rounded-lg px-4 py-2.5">
            <User className="w-4 h-4 text-cyan-600" />
            <span className="text-sm font-semibold text-cyan-700">{freelancer.name}</span>
          </div>
        )}
      </div>

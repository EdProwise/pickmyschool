  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Testimonials</h1>
          <p className="text-slate-600">Manage parent testimonials displayed on the homepage</p>
        </div>
        <Button
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li className="text-cyan-700 font-semibold">• After updating testimonials, <strong>refresh the homepage</strong> to see changes</li>
              </ul>
            </div>
          </div>
        </CardContent>
